...
export async function POST(req: Request) {
  try {
    ...
    if (error.code === "P2002") {
      return new Response(
        JSON.stringify({ error: "La clave ya está registrada" }),
        {
          status: 409,
          headers: { "Content-Type": "application/json" },
        }
    ...
    return new Response(
      JSON.stringify({ error: "Error al crear la asignatura" }),
      {
        status: 500,
        headers: { "Content-Type": "application/json" },
      }
...
export async function GET() {
  try {
    ...
    return new Response(
      JSON.stringify({ error: "Error al obtener las asignaturas" }),
      {
        status: 500,
        headers: { "Content-Type": "application/json" },
      }
...
export async function PUT(req: Request) {
  try {
    ...
    return new Response(
      JSON.stringify({ error: "Error al actualizar la asignatura" }),
      {
        status: 500,
        headers: { "Content-Type": "application/json" },
      }
...
export async function DELETE(req: Request) {
  try {
    ...
    return new Response(
      JSON.stringify({ message: "Asignatura eliminada correctamente" }),
      {
        status: 200,
        headers: { "Content-Type": "application/json" },
      }
    ...
    return new Response(
      JSON.stringify({ error: "Error al eliminar la asignatura" }),
      {
        status: 500,
        headers: { "Content-Type": "application/json" },
      }
